<div id="label-page"><h3>Tampil Data Buku Perpustakaan</h3></div>
<div id="content">
	<div align="right">
	<!-- <FORM CLASS="form-inline" METHOD="POST">
	<div><form method=post><input type="text" name="pencarian"><input type="submit" name="search" value="search" class="tombol"></form>
	</FORM> -->
	</p>
