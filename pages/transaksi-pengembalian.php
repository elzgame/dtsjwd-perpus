	...
	<div align="right">
		...
		<table id="tabel-tampil">
			...
			?>
					<tr>
						...
						<td>
							<div class="tombol-opsi-container"><a href="proses/buku-restok.php?id=<?php echo $r_tampil_transaksi['idtransaksi']; ?>" onclick="return confirm ('Apakah Anda Yakin Akan Merestok Data Ini ke Daftar Peminjaman?')" class="tombol">Restok Buku (TEMP) </a></div>
						</td>
					</tr>
			<?php $nomor++;
				}
		...
		if (isset($_POST['pencarian'])) {
			...
			<div style="float: left;">
				<?php
				$jml = mysqli_num_rows(mysqli_query($db, $queryJml)) - $countpage;
