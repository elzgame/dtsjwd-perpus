...
<div id="content">
	...
	<p id="tombol-tambah-container"><a href="index.php?p=anggota-input" class="tombol">Tambah Anggota</a>
		<a target="_blank" href="proses/cetak-semua-anggota.php"><img src="print.png" height="50px" height="50px"></a>
	...
	<table id="tabel-tampil">
		...
		?>
				<tr>
					...
					<td>
						<div class="tombol-opsi-container"><a href="proses/cetak-kartu-anggota.php?id=<?php echo $r_tampil_anggota['idanggota']; ?>" class="tombol">Cetak Kartu</a></div>
